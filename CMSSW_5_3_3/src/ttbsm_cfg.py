...
if not options.useData :
    ...
    process.source.fileNames = [
        '/store/data/Run2012D/JetHT/RECO/PromptReco-v1/000/203/853/06659F81-D40B-E211-890F-001D09F24353.root'
    ]
...
# CA8 Pruned jets
process.selectedPatJetsCA8PrunedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")


# CA8 TopJets
process.selectedPatJetsCATopTagPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
...
process.selectedPatJetsCAHEPTopTagPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
...
if options.useExtraJetColls: 
	# CA12 Filtered jets
	process.selectedPatJetsCA12FilteredPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsCA12MassDropFilteredPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")

	# AK5 groomed jets
	process.selectedPatJetsAK5PrunedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK5TrimmedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK5FilteredPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")


	# AK7 groomed jets
	process.selectedPatJetsAK7PF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK7PrunedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK7TrimmedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK7FilteredPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")


	# AK8 groomed jets
	process.selectedPatJetsAK8PF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK8PrunedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK8TrimmedPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
	process.selectedPatJetsAK8FilteredPF.cut = cms.string("pt > 50 & abs(rapidity) < 2.5")
...
process.selectedPatElectronsPFlowLoose.cut = cms.string('pt > 50.0 & abs(eta) < 2.4')
...
process.selectedPatMuonsPFlowLoose.cut = cms.string("pt > 50.0 & abs(eta) < 2.1")
...
process.manystripclusORnoTrackRecoAOD     = cms.EDFilter("LogErrorEventFilter",
                                                                ...
                                                                modulesToWatch=cms.vstring("PhotonConversionTrajectorySeedProducerFromSingleLeg:photonConvTrajSeedFromSingleLeg")
                                       )
